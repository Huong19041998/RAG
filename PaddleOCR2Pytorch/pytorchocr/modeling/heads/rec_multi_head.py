    ...
    def __init__(self, in_channels, out_channels_list, **kwargs):
        ...
        for idx, head_name in enumerate(self.head_list):
            ...
            if name == 'SARHead':
                ...
                # print("sar_args ",in_channels,out_channels_list['SARLabelDecode'])
            elif name == 'NRTRHead':
                pass
                ...
                #     out_channels=out_channels_list['NRTRLabelDecode']) #######+1
                # print("NRTRHead ",out_channels_list['NRTRLabelDecode'])
            elif name == 'CTCHead':
                # ctc neck
